 ...
 * @author MaQ
 */
public class InternetAppsLoader implements IAppsLoader, Serializable {

    private String apps_file = "C:\\xml\\internet.xml";
    ...
    public ArrayList<App> LoadExtendedApps() {
        return XMLParser.ParseFile("C:\\xml\\internet_extended.xml");
    }
}
