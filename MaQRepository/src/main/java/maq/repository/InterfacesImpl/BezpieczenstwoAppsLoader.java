 ...
 * @author MaQ
 */
public class BezpieczenstwoAppsLoader implements IAppsLoader, Serializable {

    private String apps_file = "C:\\xml\\bezpieczenstwo.xml";
    ...
    public ArrayList<App> LoadExtendedApps() {
        return XMLParser.ParseFile("C:\\xml\\bezpieczenstwo_extended.xml");
    }
}
